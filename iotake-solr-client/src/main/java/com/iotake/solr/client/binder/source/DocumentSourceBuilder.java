...
import com.iotake.solr.client.binder.annotation.SolrReadable;
...
public class DocumentSourceBuilder {
  ...
  private FieldSource getFieldSource(Class<?> documentClass, Field field,
    ...
    com.iotake.solr.client.binder.annotation.SolrDocument solrDocument = targetType
        .getAnnotation(com.iotake.solr.client.binder.annotation.SolrDocument.class);
